...
const projects = [
  {
    title: '麦芽小达人商城',
    description: '独立主导的图书电商平台，历经 6 年持续迭代，完成 Vue2 → Vue3 架构升级，支撑公众号与小程序双端运营及多种营销玩法。',
  ...
  {
    title: '麦芽海外购',
    description: '从零搭建的跨境电商小程序（香港主体），独立打通海关三单对碰、微信支付合规上报及多保税仓物流链路，3 个月内完成上线。',
  ...
  {
    title: '麦芽推荐官',
    description: '多平台商品聚合分销小程序，设计统一商品适配层对接微信小店等多源数据，支撑推广员实时佣金追踪与裂变传播。',
  ...
  {
    title: '好卖好买商城（B端）',
    description: '面向代理商的 B 端供应链平台，设计囤货-代发-云仓一体化业务流，支持批量订单处理，持续服务 6 年稳定运行。',
  ...
  {
    title: '麦芽云助手',
    description: '软硬件协同的智能点读设备配套小程序，攻克微信蓝牙 BLE 配网与大文件稳定传输难题，支撑用户自制点读包创作与分享。',
  ...
  {
    title: '景尚订房',
    description: '物联网短租平台，通过 WebSocket 实时房态同步 + 蓝牙 BLE 智能门锁对接，实现预订-支付-无钥匙入住全流程闭环。',
...
const filteredProjects = computed(() =>
  activeFilter.value === '全部' ? projects : projects.filter((p) => p.category === activeFilter.value)
)
</script>
