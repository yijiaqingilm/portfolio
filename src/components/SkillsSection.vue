  ...
  <section id="skills" class="py-20 sm:py-28">
    <div class="max-w-6xl mx-auto section-padding">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div
            class="w-11 h-11 bg-accent/10 dark:bg-accent/20 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300"
          >
            <svg
