...
<template>
  <section id="about" class="py-20 sm:py-28 bg-zinc-50 dark:bg-zinc-900/50">
    <div class="max-w-6xl mx-auto section-padding">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div>
          ...
          <div class="fade-up mt-6 space-y-4 text-zinc-500 dark:text-zinc-300 leading-relaxed">
            <p>
              入行十年，大部分时间扎在电商领域。从最初用 jQuery 切页面，到如今围绕 Vue 生态独立交付完整产品——这条路上最大的收获不是技术栈变宽了，而是学会了<span class="text-zinc-700 dark:text-zinc-100 font-medium">从业务出发做技术决策</span>。
            </p>
            <p>
              我习惯一个人扛完从需求到上线的全流程：前端用 Vue/uni-app 搭界面，服务端用 Node.js 写接口，数据库自己设计。这种工作方式让我对系统全局有清晰的认知，也让我在跨境电商海关对接、蓝牙硬件通信这类<span class="text-zinc-700 dark:text-zinc-100 font-medium">跨领域问题</span>上能快速找到落地方案。
            </p>
            <p>
              我不是那种追新框架的人，更在意<span class="text-zinc-700 dark:text-zinc-100 font-medium">代码能不能持续跑三年五年</span>。我维护最久的项目已经第七年了，依然在线上稳定服务——这是我最引以为傲的事。
            </p>
          </div>
          ...
          <div class="fade-up mt-10 grid grid-cols-2 sm:grid-cols-4 gap-6">
            <div v-for="stat in stats" :key="stat.label" class="text-center group cursor-default">
              ...
              <div class="mt-1 text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider group-hover:text-zinc-700 dark:group-hover:text-zinc-200 transition-colors duration-300">{{ stat.label }}</div>
            </div>
          </div>
        </div>
      </div>
